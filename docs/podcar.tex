...
The values for parameters such as minimum turning radius were calculated from the
technical specifications of the base vehicle \cite(SHOPRIDERSPECS).
...
This project has received funding from EU H2020 interACT: Designing cooperative interaction of automated vehicles with other road users in mixed traffic environments under grant agreement No 723395.   Thanks to Jacob Lord for creating the graphical mesh model, Yao Chen for scoping Dubins path methods, Gabriel Walton for scoping simulation tools.
