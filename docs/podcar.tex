...
\begin{document}
    ...
    \author{
        Fanta Camara\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}, \IEEEauthorblockN{Chris Waltham\IEEEauthorrefmark{2}, David Churchill\IEEEauthorrefmark{2}, Charles W. Fox\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}}
...
New vehicle electronics are added on an acrylic board mounted under the seat of the vehicle, as shown in fig. \ref{fig:circuitDiagram} and \ref{fig:actuatorMounted} and mounted as in fig. {fig:actuatorMounted}. Details are described below.  Where different voltage power supplies are required, DCDC converters are used and mounted in the same way.
...
TODO Dom Li is working on this...
...
\begin{figure}[h]
      ...
      \caption{Gazebo simulation world}
      \label{fig:sim_world}
\end{figure}
...
TODO: Fanta and her Leeds student and working on OrbSLAM, NDT slam options?
...
This project has received funding from EU H2020 interACT: Designing cooperative interaction of automated vehicles with other road users in mixed traffic environments under grant agreement No 723395.   Thanks to Jacob Lord for creating the graphical mesh model, Yao Chen for scoping Dubins path methods and the mechanical design, Gabriel Walton for scoping simulation tools.
...
\subsection{Lidar}
\subsubsection{No velodyne\_points message published}
